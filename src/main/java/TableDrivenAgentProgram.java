...
public class TableDrivenAgentProgram implements AgentProgram {
    ...
    TableDrivenAgentProgram(Map<List<Percept>, Action> perceptSequenceActions) {
...
public class TableDrivenAgentProgram {
    private List<Percept> percepts = new ArrayList<>();
    private Table<List<Percept>, String, Action> table;
    private static final String ACTION = "action";
    ...
    public TableDrivenAgentProgram(Map<List<Percept>, Action> seq) {
